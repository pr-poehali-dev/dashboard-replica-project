      ...
      <div className="flex h-full">
        <div className="p-6 w-1/2">
          <div className="flex gap-2 mb-4">
            {tags.map((tag, index) => (
              <Badge key={index} className="bg-[#FFF8E7] text-[#823C42] rounded-full px-4 py-1 flex items-center">
          ...
          <div className="flex items-center">
            <div className="flex -space-x-2 mr-3">
              <Avatar className="border-2 border-[#823C42] w-8 h-8">
                <img src={imageSrc} alt="avatar" className="object-cover" />
              </Avatar>
              <Avatar className="border-2 border-[#823C42] w-8 h-8 bg-[#6D2C32]">
                <img src={imageSrc} alt="avatar" className="object-cover" />
              </Avatar>
              <Avatar className="border-2 border-[#823C42] w-8 h-8 bg-[#512226]">
                <img src={imageSrc} alt="avatar" className="object-cover" />
              </Avatar>
            </div>
        ...
        <div className="flex-1 relative">
          ...
          />
          {/* Наложение изображения героя */}
          <div className="absolute inset-0 bg-gradient-to-r from-[#823C42] to-transparent w-24"></div>
        </div>
      </div>
    </Card>
  );
